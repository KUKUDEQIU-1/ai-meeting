const ACTION_VERBS = ['完成', '推进', '处理', '修复', '回归', '准备', '上线', '验收', '测试', '联调', '对接', '接入', '开发', '搭建', '输出', '整理', '梳理', '配置', '制定', '优化', '改造', '迁移', '发布', '发版', '跑通', '部署', '收尾', '分享', '试部署', '修改', '补齐', '补全', '发送', '同步', '调试', '维护', '适配', '解决', '评审', '调研', '分析', '完善', '沟通', '协调', '校验', '复测'];
